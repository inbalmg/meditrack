...
function buildFillers() {
  ...
  const rows = [
    ...
    [1, 16, 30, 'p2', 'tr2', 'קבוע'],
    [2, 9, 0, 'p5', 'tr1', 'קבוע'], [2, 9, 30, 'p4', 'tr4', 'קבוע'],
    ...
    [3, 15, 30, 'p6', 'tr1', 'קבוע'],
    [4, 9, 0, 'p2', 'tr2', 'קבוע'], [4, 9, 30, 'p4', 'tr5', 'קבוע'],
...
export const seedTasks = [
  ...
  { id: 'k2', title: 'בקשת "לא בטוח" ממתינה — שירה גולן', patientId: 'p3', assigneeId: 't3', due: at(0, 16, 0), status: 'בטיפול', source: 'אוטומציה', note: 'ה-AI הציע עיסוי רפואי — לאשר ולהציע מועד.' },
  { id: 'k3', title: 'לחזור עם המלצת תרגילים — אבי מזרחי', patientId: 'p2', assigneeId: 't1', due: at(1, 10, 0), status: 'הושלם', source: 'ידני', note: 'נשלח דף תרגילים לבית.' },
